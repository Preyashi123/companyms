...
FOREIGN KEY (sector) REFERENCES Sector(sectorname)  ON DELETE CASCADE
 ...
 insert into Company(companyname,ceo,sector,companycode,companydetails) 
 values('abc','xyez','agr',1002,'it is 1002 company');
 insert into Company(companyname,ceo,sector,companycode,companydetails) 
 values('abcd','tree','agr',1005,'it is 1005 company');
  insert into Company(companyname,ceo,sector,companycode,companydetails) 
 values('xyz','tr1','agr',1008,'it is 1008 company');
